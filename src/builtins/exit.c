...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/06 18:37:23 by ybouaoud          #+#    #+#             */
/*   Updated: 2024/08/31 18:13:38 by amouhand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	*i = skip_whitespace(cmd->args[1], *i);
...
void	exit_norm(t_cmd *cmd, int *exit_status, pid_t pid)
{
	...
	if (cmd->count > 1)
	{
		...
		*exit_status = get_parser()->exit_status;
}
